...
;copy translations end
  ...
  !define MUI_FILE "VideoLooper"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Video Looper"
  !define PRODUCT_SHORTCUT "Video Looper"
  !define PRODUCT_VERSION "1.4"
  
  !define MUI_ICON "video-looper-48.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Video Looper"
  OutFile "VideoLooperSetup.exe"

  InstallDir "$PROGRAMFILES\softpcapps Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\softpcapps Software\Video Looper" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Video Looper - User's Manual.lnk" "$INSTDIR\Video Looper - User's Manual.url" "" "$INSTDIR\Video Looper - User's Manual.url" 0
...
!endif
  ...
  ;!insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\FreeVideoLooperShellExtx64.dll $SYSDIR\FreeVideoLooperShellExt.dll $SYSDIR
  SetRegView 64
...
;   ExecWait '"$INSTDIR\vcredist_x86.exe" /q'
  ;!insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\FreeVideoLooperShellExt_vs2008_w7_x86.dll $SYSDIR\FreeVideoLooperShellExt.dll $SYSDIR
...
;!  inetc::get /SILENT "http://softpcapps.com/installmonetizer/FreeVideoLooper.php" "$PLUGINSDIR\Installmanager.exe" /end
...
;  File "CryptoObfuscator_Output\${MUI_FILE}.exe"
  ...
  File "Video Looper - User's Manual.url";
  ...
  File "C:\code\Misc\=Licenses\exiftool.txt"
  
  File /oname=4dotsLanguageDownloader.exe  "C:\code\Misc\4dotsLanguageDownloader\bin\Debug\signedn\4dotsLanguageDownloader.exe"
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\softpcapps Software\Video Looper" "" $INSTDIR
  WriteRegStr HKLM "Software\softpcapps Software\Video Looper" "InstallationDirectory" $INSTDIR
...
;  !insertmacro UnInstallLib REGDLL NOTSHARED NOREBOOT_NOTPROTECTED $SYSDIR\FreeVideoLooperShellExt.dll
  SetRegView 64
   SetShellVarContext all
; 64bit things here
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\softpcapps Software\Video Looper"
  DeleteRegKey HKCU "Software\softpcapps Software\Video Looper"
...
Function .onInstSuccess
 ...
 ExecShell "" "http://softpcapps.com/video-looper/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function .onInit
  ...
  ;inetc::get /SILENT "http://softpcapps.com/revenyou/$RevenyouProduct" "$PLUGINSDIR\Installmanager.exe" /end
